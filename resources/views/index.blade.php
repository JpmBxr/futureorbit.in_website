            ...
            <div class="col-md-7">
                <div class="home-slide-face aos" data-aos="fade-up">
                    <div class="home-slide-text ">
                        ...
                        <ul>
                        <li>
                       <h2 style="font-size: 30px;"> Providing the confidence to your child in every subject from standard III to VIII.</h2>
                        </li> 
                        <br> 
                        <li>
                       <h2 style="font-size: 30px;"> Specialised coaching from class IX to XII in Physics, Chemistry, Mathematics & Biology to crack JEE/NEET in first attempt.</h2>
                        </li>       
                    </ul>
